...
namespace AdvanceMYS.Migrations
{
    ...
    [Migration("20210220134410_examples3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainClass.DomainClass.DicExamples", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("DicTblId")
                        .HasColumnType("int");

                    b.Property<int>("ExampleTbl")
                        .HasColumnType("int");

                    b.Property<int?>("exampleTblId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("exampleTblId");

                    b.ToTable("DicExamples");
                });
            ...
            modelBuilder.Entity("DomainClass.DomainClass.DicExamples", b =>
                {
                    b.HasOne("DomainClass.DomainClass.DicTbl", "dicTbl")
                        .WithMany("dicExamples")
                        .HasForeignKey("DicTblId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DomainClass.DomainClass.ExampleTbl", "exampleTbl")
                        .WithMany("dicExamples")
                        .HasForeignKey("exampleTblId");

                    b.Navigation("dicTbl");

                    b.Navigation("exampleTbl");
                });
