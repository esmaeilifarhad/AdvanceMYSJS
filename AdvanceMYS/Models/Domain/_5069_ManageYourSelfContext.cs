...
{
    public partial class _5069_ManageYourSelfContext : DbContext
    {
        //public _5069_ManageYourSelfContext()
        //{
        //}

        public _5069_ManageYourSelfContext(DbContextOptions<_5069_ManageYourSelfContext> options)
            : base(options)
        {
        }
